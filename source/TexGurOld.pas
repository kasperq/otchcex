...
procedure TFTexGurOld.TexGurSost;
begin
try
 StartWait;
...
procedure TFTexGurOld.Edit1Change(Sender: TObject);
...
procedure TFTexGurOld.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFTexGurOld.FormCreate(Sender: TObject);
begin
...
procedure TFTexGurOld.Edit2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if key=vk_return then
 begin
...
procedure TFTexGurOld.Edit3Click(Sender: TObject);
begin
 edit3.Text:=''
end;

procedure TFTexGurOld.Edit3KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=vk_return then
 begin
...
procedure TFTexGurOld.Edit9Click(Sender: TObject);
begin
edit9.Text:=''
end;

procedure TFTexGurOld.Edit9KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if key=vk_return then
 begin
...
procedure TFTexGurOld.Edit1Click(Sender: TObject);
begin
 edit1.text:='';
 edit2.text:='';
 vSeria_id:=0;
...
procedure TFTexGurOld.ToolButton3Click(Sender: TObject);
 var
 usl_ser: string;
begin
...
procedure TFTexGurOld.DBGridEh1EditButtonClick(Sender: TObject);
begin
...
procedure TFTexGurOld.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TFTexGurOld.MyGetValue(const s: String; var v: Variant);
begin
 if UpperCase(S)='K1' then if FTexGurOld.Edit5.Text<>'' then v:=strtofloat(FTexGurOld.Edit5.Text) else v:=0;
 if UpperCase(S)='K2' then if FTexGurOld.Edit6.Text<>'' then v:=strtofloat(FTexGurOld.Edit6.Text) else v:=0;
 if UpperCase(S)='K3' then if FTexGurOld.Edit7.Text<>'' then v:=strtofloat(FTexGurOld.Edit7.Text) else v:=0;
 if UpperCase(S)='K4' then if FTexGurOld.Edit8.Text<>'' then v:=strtofloat(FTexGurOld.Edit8.Text) else v:=0;
 if UpperCase(S)='WT' then if FTexGurOld.Edit16.Text<>'' then v:=strtofloat(FTexGurOld.Edit16.Text) else v:=0;
 if UpperCase(S)='MC' then if FTexGurOld.Edit10.Text<>'' then v:=strtofloat(FTexGurOld.Edit10.Text) else v:=0;
 if UpperCase(S)='MKC' then if FTexGurOld.Edit14.Text<>'' then v:=strtofloat(FTexGurOld.Edit14.Text) else v:=0;
 if UpperCase(S)='W' then if FTexGurOld.DBEdit11.Text<>'' then v:=strtofloat(FTexGurOld.DBEdit11.Text) else v:=0;
 if UpperCase(S)='C' then if FTexGurOld.DBEdit8.Text<>'' then v:=strtofloat(FTexGurOld.DBEdit8.Text) else v:=0;
 if UpperCase(S)='WK'  then if FTexGurOld.DBEdit5.Text<>'' then v:=strtofloat(FTexGurOld.DBEdit5.Text) else v:=0;
 if UpperCase(S)='MT' then if FTexGurOld.Edit3.Text<>'' then v:=strtofloat(FTexGurOld.Edit3.Text) else v:=0;
 if UpperCase(S)='V2' then if FTexGurOld.Edit9.Text<>'' then v:=strtofloat(FTexGurOld.Edit9.Text) else v:=0;
 if UpperCase(S)='MM' then if FTexGurOld.Edit13.Text<>'' then v:=strtofloat(FTexGurOld.Edit13.Text) else v:=0;
 if UpperCase(S)='M' then if FTexGurOld.dbEdit7.Text<>'' then v:=strtofloat(FTexGurOld.dbEdit7.Text) else v:=0;
 if UpperCase(S)='N' then if FTexGurOld.Edit12.Text<>'' then v:=strtofloat(FTexGurOld.Edit12.Text) else v:=0;
 if UpperCase(S)='PN' then v:=TexGurPlnorm.AsFloat;
end;

procedure TFTexGurOld.MyGetValue1(const s: String; var v: Variant);
begin
...
procedure TFTexGurOld.TexGurAfterDelete(DataSet: TDataSet);
begin
if s_del<>0 then
begin
 if not dm1.IBT_WRITE.Active then dm1.IBT_WRITE.StartTransaction;
...
procedure TFTexGurOld.TexGurAfterScroll(DataSet: TDataSet);
begin
...
procedure TFTexGurOld.Button1Click(Sender: TObject);
 var s_kol: double;
begin
...
procedure TFTexGurOld.PageControl1Change(Sender: TObject);
begin
...
procedure TFTexGurOld.FormShow(Sender: TObject);
begin
...
procedure TFTexGurOld.DBGridEh3SortMarkingChanged(Sender: TObject);
var
  i :Integer;
begin
 Usl_Sort := '';
...
procedure TFTexGurOld.DBGridEh4SortMarkingChanged(Sender: TObject);
...
procedure TFTexGurOld.DateEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if key=vk_return then
...
procedure TFTexGurOld.Edit2Click(Sender: TObject);
begin
 edit2.text:='';
 edit3.text:='';
 edit9.text:='';
...
procedure TFTexGurOld.ToolButton2Click(Sender: TObject);
begin
...
procedure TFTexGurOld.ToolButton1Click(Sender: TObject);
...
procedure TFTexGurOld.DBGridEh3EditButtonClick(Sender: TObject);
var
  nm : integer;
begin
  nm := 0;
...
procedure TFTexGurOld.TexGurKSM_IDValidate(Sender: TField);
begin
...
procedure TFTexGurOld.frReport2GetValue(const ParName: String;
  var ParValue: Variant);
begin
 if ParName='Kod_prod' then ParValue:=FTexGurOld.Edit1.Text;
 if ParName='gost' then ParValue:=FTexGurOld.Label22.Caption;
 if ParName='xarkt' then ParValue:=FTexGurOld.Label11.Caption;
 if ParName='namorg' then ParValue:=FTexGurOld.Label29.Caption;
 if ParName='namcex' then ParValue:=FGlMenu.RxLabel1.Caption;
 if ParName='nmat' then ParValue:=FTexGurOld.Label19.Caption;
 if ParName='neis' then ParValue:=FTexGurOld.Label21.Caption;
 if ParName='seria' then ParValue:=FTexGurOld.Edit2.Text;
 if ParName='obem' then ParValue:=FTexGurOld.Edit3.Text;
 if ParName='dat_ser' then ParValue:=FTexGurOld.DateEdit1.Text;


end;

procedure TFTexGurOld.ToolButton5Click(Sender: TObject);
begin
...
procedure TFTexGurOld.ToolButton6Click(Sender: TObject);
begin
...
procedure TFTexGurOld.ToolButton8Click(Sender: TObject);
begin
...
procedure TFTexGurOld.SpeedButton1Click(Sender: TObject);
var
usl_dat_s: string;
begin
 usl_dat_s:=usl_dat;
...
procedure TFTexGurOld.SpeedButton2Click(Sender: TObject);
begin
...
procedure TFTexGurOld.Edit13KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if key=vk_return then
 begin
...
procedure TFTexGurOld.Edit16KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
{ if key=vk_return then
 BEGIN
...
procedure TFTexGurOld.TexGurKRAZValidate(Sender: TField);
begin
...
procedure TFTexGurOld.TexGurBeforeDelete(DataSet: TDataSet);
begin
...
procedure TFTexGurOld.TexGurBeforePost(DataSet: TDataSet);
var
  seria_ids: integer;
begin
...
procedure TFTexGurOld.Seria_sBeforeInsert(DataSet: TDataSet);
begin
DM1.AddSeria.ExecProc;
vSERIA_IDs:=DM1.AddSeria.Params.Items[0].AsInteger;
end;

procedure TFTexGurOld.Seria_sNewRecord(DataSet: TDataSet);
begin
...
procedure TFTexGurOld.Button2Click(Sender: TObject);
var
M_ov1: double;
M_ov: double;
M_ov2: double;
...
procedure TFTexGurOld.Button3Click(Sender: TObject);
begin
...
procedure TFTexGurOld.DBEditEh1EditButtons0Click(Sender: TObject;
  var Handled: Boolean);
begin
 if FindMatrop=nil then FindMatrop:=TfindMatrop.Create(Application);
 FindMatrop.DataBaseName:=dm1.BELMED;
...
procedure TFTexGurOld.DBEditEh2EditButtons0Click(Sender: TObject;
  var Handled: Boolean);
begin
 ...
 begin
  if FSer=nil then FSer:=TFSer.Create(Application);
  dm1.DS_Seria.DataSet:=FTexGurOld.seria_s;
  pr_ser:=1;
  FSer.ShowModal;
  if FSer.ModalResult > 50 then
  begin
...
procedure TFTexGurOld.Ceh_MarshNewRecord(DataSet: TDataSet);
begin
...
procedure TFTexGurOld.Ceh_MarshKSM_IDOVValidate(Sender: TField);
begin
 dM1.Matrop.Active:=false;
...
procedure TFTexGurOld.Ceh_MarshSERIAValidate(Sender: TField);
begin
...
procedure TFTexGurOld.DBEditEh3EditButtons0Click(Sender: TObject;
  var Handled: Boolean);
begin
if FindMatrop=nil then FindMatrop:=TfindMatrop.Create(Application);
    FindMatrop.DataBaseName:=dm1.BELMED;
...
procedure TFTexGurOld.DBEditEh3KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key=vk_return then
 begin
...
procedure TFTexGurOld.SpinEdit3Change(Sender: TObject);
begin
 mes:=SpinEdit3.Value;
 IF MES<10 THEN S_MES:='0'+INTTOSTR(MES) ELSE S_MES:=INTTOSTR(MES);
...
procedure TFTexGurOld.SpinEdit4Change(Sender: TObject);
begin
god:=SpinEdit4.Value;
IF MES<10 THEN S_MES:='0'+INTTOSTR(MES) ELSE S_MES:=INTTOSTR(MES);
  S_DAT1_period:='01.'+S_MES+'.'+copy(INTTOSTR(GOD),3,2);
...
procedure TFTexGurOld.TexGurNewRecord(DataSet: TDataSet);
begin
...
procedure TFTexGurOld.ToolButton4Click(Sender: TObject);
begin
...
procedure TFTexGurOld.DBEditEh2Click(Sender: TObject);
begin
DBeditEH2.text:='';
end;

procedure TFTexGurOld.DBEditEh1Click(Sender: TObject);
begin
